...
const OrderSummary = () => {
  const {grandTotal,selectedItems,tax,taxRate,totalPrice} = useAppSelector((state)=>state.cart)
  return (
    <div className=" lg:w-80 w-full h-full bg-primary bg-opacity-35 rounded">
      <div className="px-6 py-4 space-y-10">
        ...
        <p className="text-sm text-dark mt-2">Tax : ${Math.floor(taxRate*100).toFixed(2)}  : ${tax} </p>
